...
import ucuenca.edu.sg.controller.DetalleValorController;
 ...
 */
@ManagedBean
public class DetalleValorConverter implements javax.faces.convert.Converter{
    @EJB
    private DetalleValorFacade ejbFacade;
    @Override
